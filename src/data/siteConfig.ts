...
export const siteConfig = {
  ...
  legalName: "Niharika Artist",
  url: "https://niharikartist.shop",
  description:
    "Original paintings, graphite and colour pencil portraits, caricature and live wedding art by Hyderabad-based artist Ananthoja Niharika.",
  nav: [
    { label: "Home", href: "/" },
